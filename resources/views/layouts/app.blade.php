            ...
            <div class="header">
                @section('header')
                    ...
                    <ul class="menu-list">
                        ...
                        <li class="home"><a href="category-basketball">bóng rổ</a></li>
                        <li class="home"><a href="category-football">bóng đá</a></li>
                        <li class="home"><a href="category-volleyball">bóng chuyền</a></li>
                        <li class="home"><a href="category-esport">esport</a></li>
                        <li class="search">
                            <form class="d-flex search"  method="GET" >
                                <input type="hidden" name="slug" id="convert_slug">
                                <input id="slug" onkeyup="ChangeToSlug();"  class="form-control me-2" type="search" placeholder="Search" aria-label="Search">
                                <button class="btn btn-search" style="border: none" type="submit"  >
